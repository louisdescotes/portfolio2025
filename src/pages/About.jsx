const About = () => {
    return(
        <section className="gridCol h-full maxWidth">
            <aside className="col-start-1 col-end-5 row-start-2 row-end-5 flex justify-center flex-col lg:pl-[100px] lg:px-0 2xl:px-0 px-5">
